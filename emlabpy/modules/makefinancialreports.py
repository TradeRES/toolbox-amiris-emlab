...
class CreatingFinancialReports(DefaultModule):
    ...
    def createFinancialReportsForPowerPlantsAndTick(self):
        ...
        for powerplant in self.reps.get_operational_and_to_be_decommissioned_power_plants_by_owner(self.reps.agent):
            ...
            financialPowerPlantReport.setOverallRevenue(financialPowerPlantReport.capacityMarketRevenues_in_year + dispatch.revenues)
            financialPowerPlantReport.setTotalYearlyProfit(financialPowerPlantReport.capacityMarketRevenues_in_year + dispatch.revenues + yearly_costs)
