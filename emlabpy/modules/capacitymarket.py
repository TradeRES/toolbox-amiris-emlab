...
class CapacityMarketSubmitBids(MarketModule):
    ...
    def act(self):
        ...
        for powerplant in self.reps.get_operational_almost_operational_and_to_be_decommissioned(market.forward_years_CM):
            ...
            profits =self.reps.get_expeceted_profits_by_tick( powerplant.name ,self.reps.current_tick + market.forward_years_CM)
            ...
            print(powerplant.name + ";" + str(price_to_bid) + ";" + str(profits) + ";"+  str(fixed_on_m_cost)+ ";" +  str(pending_loan))
...
class CapacityMarketClearing(MarketModule):
    ...
    def act(self):
        ...
        clearing_price, total_supply_volume, isTheMarketCleared = self.capacity_market_clearing(sorted_ppdp, market, capacity_market_year )
